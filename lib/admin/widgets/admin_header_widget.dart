...
class AdminHeaderWidget extends StatefulWidget {
  ...
  const AdminHeaderWidget(this._height, this._showIcon, this._icon, {Key? key})
      : super(key: key);

  @override
  _AdminHeaderWidgetState createState() =>
      _AdminHeaderWidgetState(_height, _showIcon, _icon);
}
...
class _AdminHeaderWidgetState extends State<AdminHeaderWidget> {
  ...
  _AdminHeaderWidgetState(this._height, this._showIcon, this._icon);
