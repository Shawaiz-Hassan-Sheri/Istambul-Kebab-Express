...
class ManagerMenuItems extends StatefulWidget {
  @override
  State<ManagerMenuItems> createState() => _ManagerMenuItemsState();
}

class _ManagerMenuItemsState extends State<ManagerMenuItems> {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      if (isItemSelected) {
        ...
        for (Items selectedItem in selectedItems) {
          ...
          if (selectedItem.itemID == item1.itemID) {
