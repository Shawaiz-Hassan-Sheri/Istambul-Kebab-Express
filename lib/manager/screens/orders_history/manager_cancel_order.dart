...
class ManagerCancelOrder extends StatefulWidget {
  late String userid;
  ManagerCancelOrder({required this.userid});
  @override
  _ManagerCancelOrderState createState() => _ManagerCancelOrderState();
}

class _ManagerCancelOrderState extends State<ManagerCancelOrder> {
                          ...
                          ListTile(
                            ...
                            onTap: () {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => ManagerCancelOrderDetail(order: order),
                                ),
                              );
                            },
