...
class ManagerOnlineHistory extends StatefulWidget {
  late String userid;
  ManagerOnlineHistory({required this.userid});
  @override
  _ManagerOnlineHistoryState createState() => _ManagerOnlineHistoryState();
}

class _ManagerOnlineHistoryState extends State<ManagerOnlineHistory> {
                          ...
                          ListTile(
                            ...
                            onTap: () {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => Manager_Online_Order_Detail(order: order),
                                ),
                              );
                            },
