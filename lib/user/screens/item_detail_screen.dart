...
class _ItemDetailsScreenState extends State<ItemDetailsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: MyAppBar(UID: widget.model!.sellerUID),
                      ...
                      child: InkWell(
                        onTap: () async {
                          ...
                          int counterDigit = int.parse(counterText);
                           CartProvider1 cartProvider = await Provider.of<CartProvider1>(context, listen: false);
                            cartProvider.addToCart(widget.model!,counterDigit);
